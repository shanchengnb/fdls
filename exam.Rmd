...
```{r}
 # Load eviction data
evictions <- read.csv(here("data", "Evictions_20241106.csv"))

# Load community district data
community_districts <- st_read(here("data", "Community Districts.geojson"))
glimpse(evictions)
glimpse(community_districts)
```
